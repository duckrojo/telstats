...
class TelStats:
    ...
    def add_future_tels(self,
        ...
        future = {"Name": ["LSST", "JWST", "San Pedro Martin",
                           "Magdalena Ridge Observatory array",
                           "Timau National", "Iranian National",
                           "E-ELT", "GMT", "TMT"],
                  self.col_built[0]: [2022, 2021, 2023,
                                      2023,
                                      2022, 2022,
                                      2025, 2029, 2033],
                  "area": np.array([1, 1, 1,
                                    ...
                                    1, 1,
                                    1, 6, 1]) * np.pi
                  * np.array([8.4, 6.5, 6.5,
                              1.4,
                              3.8, 3.4,
                              39.3, 8.4, 30])**2 / 4.0,
                  "Site": ["Chile", "Space", "Mexico",
                           "USA",
                           "Indonesia", "Iran",
                           "Chile", "Chile", "Spain"],
                  "range": ["optical"] * 9,
